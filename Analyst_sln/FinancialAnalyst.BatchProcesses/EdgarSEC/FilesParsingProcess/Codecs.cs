...
namespace FinancialAnalyst.BatchProcesses.EdgarSEC.FilesParsingProcess
{
    ...
    /// 
    /// Codifica y decodifica UUEncode
    /// https://en.wikipedia.org/wiki/Uuencoding
    /// http://www.webutils.pl/UUencode
    /// Los archivos de input tienen que ser ANSI
    /// Los archivos de input tienen un header: 
    ///     begin [modo] [nombrearchivo]
    /// El modo no aplica a Windows, son los permisos de acceso del archivo en Unix
    /// Los archivos de input tienen 2 lineas de trailer, 1 linea vacia y una linea con "end":
    /// 
    /// end
    /// Se debe descartar header y trailer antes de usar esta clase
    /// </summary>
