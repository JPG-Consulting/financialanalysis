...
namespace FinancialAnalyst.BatchProcesses.EdgarSEC.DatasetsParsingProcess
{
    ...
    public interface IMainTask : IDisposable
    {
    ...
    public class MainTask: IMainTask
    {
        ...
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(MainTask));
        ...
        public MainTask(IEdgarDatasetsBulkRepository datasetsBulkRepo)
        {
