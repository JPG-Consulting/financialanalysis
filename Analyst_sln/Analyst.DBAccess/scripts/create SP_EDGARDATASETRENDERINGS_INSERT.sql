...
-- =============================================
/*
IF OBJECT_ID ( 'SP_EDGARDATASETRENDERINGS_INSERT', 'P' ) IS NOT NULL   
    DROP PROCEDURE SP_EDGARDATASETRENDERINGS_INSERT;  
GO
*/
CREATE PROCEDURE dbo.SP_EDGARDATASETRENDERINGS_INSERT
	@Report int
