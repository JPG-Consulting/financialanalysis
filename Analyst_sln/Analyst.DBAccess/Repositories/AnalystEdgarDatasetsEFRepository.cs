...
namespace Analyst.DBAccess.Repositories
{
    ...
    public class AnalystEdgarDatasetsEFRepository : IAnalystEdgarDatasetsRepository
    {
        ...
        #region Constructors
        public AnalystEdgarDatasetsEFRepository():this(new EdgarDatasetsContext())
        {
        }
        
        internal AnalystEdgarDatasetsEFRepository(EdgarDatasetsContext context)
        {
